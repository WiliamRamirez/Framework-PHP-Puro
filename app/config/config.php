...
define('BASEPATH'   , IS_LOCAL ? '/framework/' : '____EL BASEPATH EN PRODUCCIÓN___');
...
define('PORT'       , '8848');
define('URL'        , IS_LOCAL ? 'http://127.0.0.1:'.PORT.'/framework/' : '___URL EN PRODUCCIÓN___');
...
define('LDB_NAME'   , 'DatabaseFramework');
